...
//                             source: 'Managed vs Coworking Page'
//                         }
...
//                                             <button type="button" aria-label="Go back to phone number step" onClick={() => setFormStep('phone')} style={{ background: "#f1f5f9", border: "none", borderRadius: "50%", width: "28px", height: "28px", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}><svg width="13" height="13" fill="none" stroke="#475569" strokeWidth="2.5" viewBox="0 0 24 24" aria-hidden="true"><polyline points="15 18 9 12 15 6" /></svg></button>
//                                             <div>
...
//                         <a href="/" style={{ color: "rgba(255,255,255,.45)", transitionProperty: "color", transitionDuration: ".2s" }}>Home</a>
...
//                         <a href="/blogs/" style={{ color: "rgba(255,255,255,.45)", transitionProperty: "color", transitionDuration: ".2s" }}>Blog</a>
//                         <svg width="12" height="12" fill="none" stroke="rgba(255,255,255,.3)" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true"><polyline points="9 18 15 12 9 6" /></svg>
...
//                                     <li><a href="#what-is-coworking">What Is Coworking?</a></li>
//                                     <li><a href="#what-is-managed">What Is Managed Office?</a></li>
...
//                                     <li><a href="#when-coworking">When to Choose Coworking</a></li>
//                                     <li><a href="#when-managed">When to Choose Managed</a></li>
//                                     <li><a href="#switching">Switching Costs</a></li>
//                                     <li><a href="#expert-insight">Expert Insight</a></li>
//                                     <li><a href="#journey">Startup Journey</a></li>
//                                     <li><a href="#problems">Problems with Coworking</a></li>
//                                     <li><a href="#pros-cons">Pros &amp; Cons</a></li>
//                                     <li><a href="#why-managed">Why Managed Offices</a></li>
//                                     <li><a href="#locations">Best Locations</a></li>
//                                     <li><a href="#final">Final Decision</a></li>
...
//                             {/* QUICK ANSWER BANNER */}
//                             <div className="callout reveal" id="intro" style={{ marginBottom: "28px" }}>
...
//                                 <div>
//                                     <h4>What is the difference between a managed office and coworking space?</h4>
...
//                             {/* INTRODUCTION */}
//                             <section id="intro-body" className="reveal">
//                                 <h2>Introduction</h2>
...
//                                     <div className="pill"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Managed office vs coworking comparison</div>
//                                     <div className="pill"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Hyderabad's price differences</div>
//                                     <div className="pill"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Which choice is better for new businesses?</div>
//                                     <div className="pill"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>When to switch to a managed office</div>
//                                 </div>
//                             </section>

//                             {/* FIND RIGHT WORKSPACE CTA */}
...
//                             {/* WHAT IS COWORKING */}
//                             <section id="what-is-coworking" className="reveal">
...
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Hot desks or shared seating</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Environment driven by the community</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Plans that change every month</div>
//                                 </div>
//                             </section>

//                             {/* WHAT IS MANAGED OFFICE */}
//                             <section id="what-is-managed" className="reveal">
//                                 <h2>What Is a Managed Office?</h2>
//                                 <p>A managed office is a private, fully serviced workspace made just for one business.</p>
//                                 <div className="check-list">
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>A private office</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Custom designs &amp; branding</div>
//                                 </div>
//                             </section>

//                             {/* DETAILED COMPARISON TABLE */}
//                             <section id="comparison" className="reveal">
//                                 <h2>Managed Office vs Coworking Space (Detailed Comparison)</h2>
//                                 <div style={{ overflowX: "auto", marginTop: "20px" }}>
//                                     <table className="comparison-table">
//                                         <thead>
//                                             <tr>
//                                                 <th>Factor</th>
//                                                 <th>Managed Office</th>
...
//                             {/* COST COMPARISON */}
//                             <section id="cost" className="reveal">
//                                 <h2>Cost Comparison in Hyderabad</h2>
...
//                             {/* WHICH IS RIGHT */}
//                             <section id="which-is-right" className="reveal">
//                                 <h2>Which Option Is Right for Your Startup?</h2>
//                                 <div style={{ overflowX: "auto", marginTop: "20px" }}>
//                                     <table className="comparison-table">
//                                         <thead>
//                                             <tr>
...
//                             {/* WHEN COWORKING */}
//                             <section id="when-coworking" className="reveal">
//                                 <h2>When Should Startups Choose Coworking?</h2>
//                                 <div className="check-list">
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>You're just starting out</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>The team has fewer than 10 people</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>The budget is small</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>The most important thing is flexibility</div>
//                                 </div>
//                             </section>

//                             {/* WHEN MANAGED */}
//                             <section id="when-managed" className="reveal">
//                                 <h2>When Should Startups Choose Managed Offices?</h2>
//                                 <div className="check-list">
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>The number of employees on a team goes over 10–15</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>You need privacy to do your business</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Branding becomes important</div>
//                                 </div>
//                             </section>

//                             {/* SWITCHING CTA */}
//                             <section id="switching" className="reveal">
//                                 <h2>The Cost of Moving from a Coworking Space to a Managed Office</h2>
...
//                                 <div className="check-list">
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>No money spent on infrastructure</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Little work to make the change</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>No high setup cost</div>
//                                 </div>
//                             </section>

//                             {/* EXPERT INSIGHT */}
//                             <section id="expert-insight" className="reveal">
...
//                                     <div>
//                                         <h4>What We See at PrimeDesk</h4>
...
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Founders in the early stages choose coworking because it gives them more freedom.</div>
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Startups that are growing move to managed offices within 6 to 12 months.</div>
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Funded startups choose managed offices directly so they can grow faster.</div>
//                                         </div>
//                                     </div>
//                                 </div>
//                             </section>
...
//                                 <h2>Real Example: The Journey of a Startup's Growth</h2>
//                                 <p>This is what a typical startup journey in Hyderabad looks like:</p>
//                                 <div className="journey-steps">
//                                     <div className="journey-step">
//                                         <div className="journey-left"><div className="journey-dot">1</div><div className="journey-line"></div></div>
...
//                                     </div>
//                                     <div className="journey-step">
//                                         <div className="journey-left"><div className="journey-dot">2</div><div className="journey-line"></div></div>
...
//                                     </div>
//                                     <div className="journey-step">
//                                         <div className="journey-left"><div className="journey-dot">3</div></div>
...
//                             {/* PROBLEMS */}
//                             <section id="problems" className="reveal">
//                                 <h2>Problems with Coworking Spaces That You Might Not See Right Away</h2>
//                                 <p>Coworking is a good way to save money, but it has some problems:</p>
//                                 <div className="check-list">
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>Not enough privacy</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>Distractions from a common space</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>Not much customization</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>Not good for big groups</div>
//                                 </div>
//                                 <p style={{ marginTop: "14px" }}>As teams get bigger, these problems become clearer.</p>
//                             </section>

//                             {/* PROS CONS */}
//                             <section id="pros-cons" className="reveal">
//                                 <h2>Pros and Cons of Coworking and Managed Offices</h2>
//                                 <div className="pros-cons-grid">
//                                     <div className="pros-cons-card pros">
//                                         <div className="pros-cons-title green">✓ Coworking: Pros</div>
//                                         <div className="check-list">
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Less expensive</div>
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Plans that can change</div>
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Chances to network</div>
//                                         </div>
//                                     </div>
//                                     <div className="pros-cons-card cons">
//                                         <div className="pros-cons-title orange">✗ Coworking: The Bad</div>
//                                         <div className="check-list">
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>Not enough privacy</div>
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>Things that get in the way</div>
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>Not very scalable</div>
//                                         </div>
//                                     </div>
//                                     <div className="pros-cons-card pros">
//                                         <div className="pros-cons-title green">✓ Managed Office: Pros</div>
//                                         <div className="check-list">
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Complete privacy</div>
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Customizing a brand</div>
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Can grow with teams</div>
//                                         </div>
//                                     </div>
//                                     <div className="pros-cons-card cons">
//                                         <div className="pros-cons-title orange">✗ Managed Office: The Bad</div>
//                                         <div className="check-list">
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>A little more expensive than coworking</div>
//                                         </div>
//                                     </div>
//                                 </div>
//                             </section>
...
//                             {/* WHY MANAGED */}
//                             <section id="why-managed" className="reveal">
//                                 <h2>Why Startups in Hyderabad Are Choosing Managed Offices</h2>
...
//                                         <div className="why-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg><div><strong>Ability to grow</strong><span>You can easily add more seats, from 10 to 100 or more.</span></div></div>
//                                         <div className="why-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg><div><strong>More productive teams</strong><span>A private space cuts down on distractions.</span></div></div>
//                                         <div className="why-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg><div><strong>A strong brand image</strong><span>Custom offices make clients think better of you.</span></div></div>
//                                         <div className="why-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg><div><strong>Set up faster</strong><span>Move in within days without any trouble setting up.</span></div></div>
//                                     </div>
//                                 </div>
//                                 <blockquote><p>Managed offices might not be the best choice if your team has fewer than 3–5 people, you don't have much money, or you need a workspace for a very short time. In these situations, coworking spaces might be a better place to start.</p></blockquote>
//                             </section>

//                             {/* LOCATIONS */}
//                             <section id="locations" className="reveal">
//                                 <h2>Best Locations for Startups in Hyderabad</h2>
...
//                             {/* FINAL DECISION */}
//                             <section id="final" className="reveal">
//                                 <h2>Final Decision: Managed Office vs. Coworking</h2>
//                                 <div className="when-grid">
//                                     <div className="when-card coworking">
//                                         <div className="when-card-title"><span className="dot blue"></span>Choose Coworking if…</div>
//                                         <div className="check-list">
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>You're just starting out and don't want to spend a lot of money</div>
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Team has fewer than 10 people</div>
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Budget is tight</div>
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Flexibility is the priority</div>
//                                         </div>
//                                     </div>
//                                     <div className="when-card managed">
//                                         <div className="when-card-title"><span className="dot teal"></span>Choose Managed Office if…</div>
//                                         <div className="check-list">
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>You need structure and are growing</div>
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Team is over 10–15 employees</div>
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Client meetings happen often</div>
//                                             <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Branding matters to your business</div>
//                                         </div>
//                                     </div>
//                                 </div>
...
//                                     <table className="summary-table" style={{ width: "100%", borderCollapse: "collapse", borderRadius: "12px", overflow: "hidden", border: "1px solid var(--border)", fontSize: "14px" }}>
//                                         <thead style={{ background: "var(--navy)", color: "var(--white)" }}>
//                                             <tr><th style={{ padding: "12px 16px", textAlign: "left" }}>Feature</th><th style={{ padding: "12px 16px", textAlign: "left" }}>Best Option</th></tr>
//                                         </thead>
//                                         <tbody>
//                                             <tr style={{ background: "#f8fafc" }}><td style={{ padding: "12px 16px", borderBottom: "1px solid var(--border)", fontWeight: "600", color: "var(--navy)" }}>Budget</td><td style={{ padding: "12px 16px", borderBottom: "1px solid var(--border)" }}><span className="badge-blue" style={{ display: "inline-flex", alignItems: "center", background: "#eff6ff", color: "#2563eb", borderRadius: "99px", padding: "2px 10px", fontSize: "12px", fontWeight: "700" }}>Coworking</span></td></tr>
//                                             <tr><td style={{ padding: "12px 16px", borderBottom: "1px solid var(--border)", fontWeight: "600", color: "var(--navy)" }}>Privacy</td><td style={{ padding: "12px 16px", borderBottom: "1px solid var(--border)" }}><span className="badge-high" style={{ display: "inline-flex", alignItems: "center", background: "#dcfce7", color: "#16a34a", borderRadius: "99px", padding: "2px 10px", fontSize: "12px", fontWeight: "700" }}>Managed Office</span></td></tr>
//                                             <tr style={{ background: "#f8fafc" }}><td style={{ padding: "12px 16px", borderBottom: "1px solid var(--border)", fontWeight: "600", color: "var(--navy)" }}>Scalability</td><td style={{ padding: "12px 16px", borderBottom: "1px solid var(--border)" }}><span className="badge-high" style={{ display: "inline-flex", alignItems: "center", background: "#dcfce7", color: "#16a34a", borderRadius: "99px", padding: "2px 10px", fontSize: "12px", fontWeight: "700" }}>Managed Office</span></td></tr>
//                                             <tr><td style={{ padding: "12px 16px", borderBottom: "1px solid var(--border)", fontWeight: "600", color: "var(--navy)" }}>Flexibility</td><td style={{ padding: "12px 16px", borderBottom: "1px solid var(--border)" }}><span className="badge-blue" style={{ display: "inline-flex", alignItems: "center", background: "#eff6ff", color: "#2563eb", borderRadius: "99px", padding: "2px 10px", fontSize: "12px", fontWeight: "700" }}>Coworking</span></td></tr>
//                                         </tbody>
//                                     </table>
//                                 </div>
...
//                                 <div className="check-list">
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Managed workspaces</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Plug &amp; play workspaces</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>Scalable office solutions</div>
//                                     <div className="check-item"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>GCC-ready office spaces</div>
//                                 </div>
//                             </section>
...
//                                     ].map((faq, idx) => (
//                                         <div key={idx} className={`faq-item ${activeSection === idx.toString() ? 'open' : ''}`}>
//                                             <button className="faq-btn" aria-expanded={activeSection === idx.toString()} onClick={() => setActiveSection(activeSection === idx.toString() ? null : idx.toString())}>
//                                                 <span className="faq-q">{faq.q}</span>
//                                                 <div className="faq-chevron"><svg viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9" /></svg></div>
//                                             </button>
//                                             <div className="faq-body" style={{ maxHeight: activeSection === idx.toString() ? '500px' : undefined }}>
...
//                         <div className="bcs-trust-item"><svg viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /></svg>Startup-Friendly</div>
//                     </div>
//                 </div>
//             </div>
...
//                     <div className="mbc-trust-item"><svg viewBox="0 0 24 24"><path d="M22 11.08V12a10 10 10 0 1-5.93 9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg> Free Expert Advice</div>
//                 </div>
...
//         .comparison-table td.highlight-yes {
//           color: var(--teal);
//           font-weight: 700;
//         }
//         .comparison-table td.highlight-managed {
//           color: var(--navy);
//           font-weight: 700;
//         }
//         .article-intro {
